/**
 * BACKUP — original, already-shipped Detailed Tutorial content for World 1,
 * Lessons 1-3 (what-is-kotlin, kotlin-syntax, comments), saved verbatim from
 * src/data/detailedTutorialsData.ts before requesting a fresh ChatGPT rewrite
 * of these same 3 lessons, so the two versions can be compared side by side.
 *
 * NOT imported/wired into the app. Reference only.
 */
import type { DetailedTutorialData } from '../src/data/detailedTutorialsData';

export const ORIGINAL_WORLD1_LESSONS_1_TO_3: Record<string, DetailedTutorialData> = {
  // =========================================================================
