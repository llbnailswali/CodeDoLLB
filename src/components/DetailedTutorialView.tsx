...
export const DetailedTutorialView: React.FC<DetailedTutorialViewProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      className={`min-h-screen w-full flex flex-col transition-colors duration-200 select-none ${
    ...
    >
      ...
      {/* Floating Overlapped Cross Button at Top Right */}
      <button
        type="button"
        ...
        className={`fixed top-3 right-3 z-50 w-9 h-9 rounded-full flex items-center justify-center transition-all cursor-pointer active:scale-90 shadow-lg backdrop-blur-md ${
          isDark
      ...
      <main className="flex-1 max-w-2xl mx-auto w-full px-0 pt-0 pb-10 space-y-3 sm:space-y-4">
        {/* ================= HERO HEADER CARD ================= */}
        <section
          className={`px-3.5 pt-3.5 pb-4 sm:px-5 sm:pt-4 sm:pb-5 border-b transition-all relative overflow-hidden ${
            isDark
        ...
        >
          ...
          <h1
            className={`font-['Outfit'] text-2xl sm:text-3xl font-extrabold tracking-tight leading-tight mb-2 ${
          ...
          <div
            className={`rounded-2xl p-3.5 sm:p-4 border flex flex-col gap-2.5 ${
              isDark
        ...
        {tutorial.sections.map((sec, secIdx) => (
          <article
            key={sec.id}
            id={`tut-sec-${sec.id}`}
            className={`px-3.5 py-4 sm:px-5 sm:py-5 border-y transition-all scroll-mt-6 ${
              isDark
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4 pb-3 border-b border-slate-200/40 dark:border-white/5">
              ...
              <div className="flex-1 min-w-0">
                {sec.badge && (
                  <span className="text-[10px] font-mono font-bold tracking-wider uppercase text-indigo-500 dark:text-indigo-400 block">
                    {sec.badge}
                  </span>
                )}
                <h2
                  className={`font-['Outfit'] text-lg font-bold leading-tight ${
                    isDark ? 'text-white' : 'text-slate-900'
                  }`}
                >
                  {secIdx + 1}. {sec.title}
              ...
              <div className="space-y-2.5 my-4">
                {sec.bulletPoints.map((bp, bpIdx) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <h4
                        className={`text-xs font-['Outfit'] font-bold mb-0.5 ${
            ...
            {sec.codeSnippet && (
              <div className="my-4">
                ...
                >
                  ...
                  <div className="px-4 py-2 bg-slate-900/90 border-b border-white/10 flex items-center justify-between text-xs">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md text-[11px] font-mono text-slate-300 hover:text-white bg-white/5 hover:bg-white/10 transition-colors cursor-pointer"
                    >
                  ...
                  <div className="p-4 font-mono text-xs leading-relaxed overflow-x-auto whitespace-pre">
                  ...
                  {sec.codeSnippet.output && (
                    <div className="px-4 py-2.5 bg-black/40 border-t border-white/5 text-xs font-mono text-emerald-400 flex items-start gap-2">
                ...
                {sec.codeSnippet.explanation && (
                  <p
                    className={`mt-2 text-xs italic px-1 ${
                      isDark ? 'text-slate-400' : 'text-slate-500'
                    }`}
                  >
                    💡 {sec.codeSnippet.explanation}
            ...
            {sec.comparison && (
              <div className="my-5 space-y-3">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  >
                    <div className="flex items-center justify-between mb-2 font-['Outfit'] font-bold text-[11px] uppercase tracking-wide">
                      <span className="text-rose-500">{sec.comparison.leftTitle}</span>
                      <span className="px-1.5 py-0.5 rounded bg-rose-500/10 text-rose-500 text-[10px]">
                ...
                {sec.comparison.verdict && (
                  ...
                  >
                    ...
                    <span>{sec.comparison.verdict}</span>
                  </div>
                )}
              </div>
            )}
            ...
            {sec.callout && (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <h4 className="font-['Outfit'] font-bold text-xs uppercase tracking-wider mb-0.5">
                    {sec.callout.title}
                  </h4>
        ...
        >
          <div className="flex items-center gap-3 mb-5 pb-3 border-b border-slate-200/40 dark:border-white/5">
            ...
            <div>
              <span className="text-[10px] font-mono font-bold tracking-wider uppercase text-amber-500 block">
                COMPILER TRAPS
              </span>
              <h2
            ...
            {tutorial.gotchas.map((gotcha, gIdx) => (
              ...
              >
                ...
                {gotcha.badCode && gotcha.fixedCode && (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 my-2.5 font-mono text-[11px]">
                    <div
                    ...
                    >
                      ...
                      <pre className="whitespace-pre">{gotcha.badCode.join('\n')}</pre>
                    </div>
                    ...
                    >
                      ...
                      <pre className="whitespace-pre">{gotcha.fixedCode.join('\n')}</pre>
                    </div>
                  </div>
                )}
        ...
        >
          <div className="flex items-center gap-3 mb-4 pb-3 border-b border-slate-200/40 dark:border-white/5">
            ...
            <div>
              <span className="text-[10px] font-mono font-bold tracking-wider uppercase text-indigo-500 block">
                RAPID REFERENCE
              </span>
              <h2
                className={`font-['Outfit'] text-lg font-bold ${
            ...
            {tutorial.cheatsheet.map((item, cIdx) => (
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <span className="font-mono text-xs text-slate-400">{item.syntax}</span>
                </div>
                <span
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-2.5 mb-3">
                    ...
                    <h3
                      className={`text-sm font-['Outfit'] font-semibold leading-snug ${
                    ...
                    {q.options.map((opt, optIdx) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left p-3 rounded-xl border text-xs leading-relaxed transition-all cursor-pointer flex items-center justify-between gap-2 ${optStyles}`}
                        >
                          <span>{opt}</span>
                          {isAnswered && (
                            <span>
